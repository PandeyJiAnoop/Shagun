...
public class SplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usertype = sharedPreferences.getString("Role", "");
...
//        checkLogin();
        ...
        staic = findViewById(R.id.splash_img);
        staic.setAnimation(uptodown);
            ...
            public void run() {
                if (NetworkConnectionHelper.isOnline(SplashScreen.this)) {
                    if (userid.equalsIgnoreCase("")) {
                        ...
                        if (usertype.equalsIgnoreCase("Associate")){
                            Intent intent=new Intent(SplashScreen.this, AssocaiteHome.class);
                            startActivity(intent);
                        }
                        else {
    ...
    public void UpdateVersion() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Api_Urls.BaseURL+"GetVersion", new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(SplashScreen.this, "Something went wrong:-" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
