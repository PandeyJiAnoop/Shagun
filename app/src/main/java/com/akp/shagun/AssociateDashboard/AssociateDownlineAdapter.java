...
public class AssociateDownlineAdapter extends RecyclerView.Adapter<AssociateDownlineAdapter.VH> {
    Context context;
    List<HashMap<String,String>> arrayList;
    int j=0;
    RecyclerView wallet_histroy;
    ArrayList<HashMap<String, String>> arrayList1 = new ArrayList<>();
    public AssociateDownlineAdapter(Context context, List<HashMap<String,String>> arrayList) {
    ...
    public VH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.dynamic_associate_downline, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull VH vh, int i) {
        vh.Member_Idtv.setText("Member Id- "+arrayList.get(i).get("FO_ID"));
        vh.Member_nametv.setText(arrayList.get(i).get("Name"));
        vh.Branchtv.setText(arrayList.get(i).get("Branch"));
        vh.father_nametv.setText(arrayList.get(i).get("position"));
        vh.mobiletv.setText(arrayList.get(i).get("MobileNo"));
        vh.gendertv.setText(arrayList.get(i).get("IntroId"));
//        vh.RegDatetv.setText(arrayList.get(i).get("RegDate"));
        ...
        vh.view_details_ll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("memberid",arrayList.get(i).get("FO_ID"));
