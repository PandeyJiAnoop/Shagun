...
public class API_Config {
    private static String URL = "http://ujjwalapi.signaturesoftware.org/Service/";

    private static String URL1 = "https://amazepay.net/api/Amazepay/";
    ...
    public static ApiService getApiClient_ByPostRecharge()
    {
        Gson gson = new GsonBuilder() .setLenient() .create();
        OkHttpClient okHttpClient = new OkHttpClient.Builder()
                .readTimeout(120, TimeUnit.SECONDS)
